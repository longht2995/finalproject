...
public class Entry extends BaseObject<Object> {
	...
	@Value("${param.bannertop1}")
	public String BANNERBODY1 = "";
	
	@Value("${param.bannertop2}")
	public String BANNERBODY2 = "";
	
	@Value("${param.bannertop3}")
	public String BANNERBODY3 = "";
	
	@Value("${param.banerright1}")
	public String BANNERRIGHT1 = "";
	
	@Value("${param.banerright2}")
	public String BANNERRIGHT2 = "";
	
	@Value("${param.banerright3}")
	public String BANNERRIGHT3 = "";
	
	@Value("${param.banerdoithoai}")
	public String BANNERRIGHTDOITHOAI = "";
	...
	public String page(@PathVariable String path) {
		return "forward:/frontend/index.zhtml?&file=/frontend/"+path+"/home.zhtml&resource="+path+"&paging=1";
	}
	...
	public String videoId(@PathVariable Long id,@PathVariable Long idvideo) {
		return "forward:/frontend/index.zhtml?&file=/frontend/video/home.zhtml&resource=video&chudevideo="+id+"&id="+idvideo;
	}
	
	@RequestMapping(value = "/vanban/{paging}")
	public String vanbanPaging(@PathVariable String paging) {
		return "forward:/frontend/index.zhtml?&file=/frontend/vanban/home.zhtml&resource=vanban&paging="+paging;
	}
	
	@RequestMapping(value = "/vanban/id/{id}")
	public String vanbanId(@PathVariable Long id) {
		return "forward:/frontend/index.zhtml?&file=/frontend/vanban/home.zhtml&resource=vanban&id="+id;
	}
